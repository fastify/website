...
To customize this behavior you should use [`setErrorHandler`](./02-Reference/Server.md#seterrorhandler).
...
This setting can be defined in the Fastify server instance: [`bodyLimit`](./02-Reference/Server.md#bodyLimit)

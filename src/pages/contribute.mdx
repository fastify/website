...
Contributions are always welcome, we only ask you follow the [Contribution Guidelines](https://github.com/fastify/fastify/blob/master/CONTRIBUTING.md) and the [Code Of Conduct](https://github.com/fastify/fastify/blob/master/CODE_OF_CONDUCT.md).
